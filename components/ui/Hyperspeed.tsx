...
const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    const turbulentUniforms = {
      ...
      uAmp: { value: new THREE.Vector4(5, 2, 10, 10) },
    };
    ...
    const distortions: any = {
      ...
      turbulentDistortion: {
        ...
        getJS: (progress: number, time: number) => {
          ...
          const lookAtAmp = new THREE.Vector3(0, -0.3, 0);
          const lookAtOffset = new THREE.Vector3(0, -6, -10);
          return distortion.multiply(lookAtAmp).add(lookAtOffset);
        },
      },
    ...
    class App {
      ...
      loadAssets() {
        ...
        return new Promise((resolve) => {
          ...
          const searchImage = new (window as any).Image();
          const areaImage = new (window as any).Image();
          assets.smaa = {};
          searchImage.addEventListener("load", function (this: any) {
            assets.smaa.search = this;
            manager.itemEnd("smaa-search");
          });
          areaImage.addEventListener("load", function (this: any) {
  ...
  return <div id="hyperspeed-lights" ref={hyperspeed} style={{ width: "100%", height: "100%", overflow: "hidden", position: "absolute" }} />;
};
