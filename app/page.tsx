        ...
        <main className="font-[var(--font-outfit)] bg-[#0D0B09] text-[#F5F0E8]">
          ...
          <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-4 bg-[#0D0B09]/85 backdrop-blur-xl border-b border-[#D4A853]/8">
            ...
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <a
                href="tel:9729656901"
                className="inline-flex items-center gap-2 text-sm text-[#0D0B09] bg-[#D4A853] hover:bg-[#e0b964] transition-colors tracking-wide font-semibold px-4 py-2 rounded-sm"
              >
          ...
          <section className="relative min-h-screen flex items-center justify-center bg-[#0D0B09] px-6 text-center overflow-hidden">
            ...
            <div className="relative z-[2] max-w-4xl mx-auto pt-20">
              ...
              >
                <a
                  href="tel:9729656901"
                  className="w-full sm:w-auto bg-[#D4A853] text-[#0D0B09] font-semibold uppercase tracking-wider px-8 py-4 rounded-sm hover:bg-[#e0b964] transition-colors text-sm shadow-[0_10px_40px_rgba(212,168,83,0.25)]"
                >
                  Reserve Your RV &middot; (972) 965-6901
                </a>
                <a
                  href="#request-a-quote"
            ...
            <div className="relative z-[1] max-w-5xl mx-auto">
              ...
              <div className="grid md:grid-cols-[1.2fr_1fr] gap-6 md:gap-10 items-start">
                ...
                >
                  ...
                  <a
                    href="tel:9729656901"
                    className="block mt-6 bg-[#D4A853] text-[#0D0B09] font-semibold uppercase tracking-wider px-6 py-3.5 rounded-sm hover:bg-[#e0b964] transition-colors text-sm shadow-[0_8px_24px_rgba(212,168,83,0.2)]"
                  >
                    Call for a Quote
                  </a>
          ...
          <section className="relative bg-[#0D0B09] py-12 md:py-16 px-6 border-t border-[#D4A853]/10 overflow-hidden">
            ...
            <div className="relative z-[1] max-w-5xl mx-auto">
              ...
              >
                Triple W isn&rsquo;t a marketplace. It&rsquo;s a 14-unit fleet out of Tyler, Texas, run by Weston and the team.
                Every booking confirmed. Every delivery tracked. Every weekend handled.
              </motion.p>
            </div>
          </section>
